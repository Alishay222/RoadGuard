      ...
      <div className={`app-product__phone ${activeTab === 'home' ? '' : 'is-tab-active'}`}>
        ...
        <div className="app-product__chat">
          ...
          <div className="app-product__chat-trigger">
            ...
            >
              <svg viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false" role="img" style={{ width: '24px', height: '24px', display: 'block' }}>
                <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
                <path d="M8 10h.01" strokeWidth="2.4" />
                <path d="M12 10h.01" strokeWidth="2.4" />
                <path d="M16 10h.01" strokeWidth="2.4" />
              </svg>
            </button>
          </div>
        </div>
